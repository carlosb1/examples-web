...
### TODOs
[X] -> Search feature for customers

[ ] -> Add end-to-end test to mock services

[ ] -> Add update customer 

[X] -> Add create customer (backend call)

[ ] -> Copy view for services

[ ] -> Add view for accounts 

[ ] -> Update calendar to include events
